...
@section('title', 'Blog - Nvidia Blog')
    ...
    <section class="relative py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-green-900">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-5xl sm:text-6xl font-bold mb-6 nvidia-green">Blog</h1>
                <p class="text-xl text-gray-300 max-w-3xl mx-auto">
                    Stay updated with the latest innovations, tutorials, and insights from the world of AI,
